    ...
    <div class="status-grid">
      ...
      <div class="status-card">
        ...
        <div class="stats" v-if="!loadingStats">
          <p>{{ stats.ordersCount || 0 }} Orders</p>
      ...
      <div class="preview-section">
        ...
        <div class="preview-list">
          ...
          <div v-if="employees.length > 3" class="preview-more">
            +{{ employees.length - 3 }} more employees
          </div>
        </div>
      </div>
    ...
    <div class="navigation-grid">
      ...
      <div class="nav-cards">
        ...
        <router-link to="/planning" class="nav-card">
          ...
          <div class="card-count">{{ stats.planningCount || 0 }} plannings</div>
        </router-link>
      </div>
    </div>
    ...
    async checkBackend() {
      ...
      try {
        ...
        if (this.backendConnected) {
          ...
          this.showMessage('error', 'Connection failed', 'Check that Spring Boot server is running on port 8080')
        }
      } catch (error) {
